        ...
        <div className="flex-1 p-4">
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                <Button
                  ...
                  disabled={loading}
                  size="sm"
                  className="bg-[#156634] hover:bg-[#1a7a3e] text-xs h-8"
                >
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3">
                <div className="flex gap-1.5">
                  {otp.map((digit, index) => (
                    <Input
                      ...
                      className="w-9 h-10 text-center text-lg font-semibold border border-gray-300 rounded focus:border-[#156634] focus:ring-1 focus:ring-[#156634]"
                      disabled={loading}
                    />
                  ))}
                </div>
                <button
                  onClick={handleSendOTP}
                  disabled={loading}
                  className="text-xs text-[#156634] hover:underline whitespace-nowrap"
                >
                  Reenviar
                </button>
              </div>
          ...
          {step === 'success' && (
            <div className="flex items-center gap-3 py-1">
              ...
              <span className="text-sm text-gray-700">Dados preenchidos!</span>
            </div>
          )}
        </div>
      </div>
