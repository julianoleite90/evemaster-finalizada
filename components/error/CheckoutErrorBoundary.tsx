...
async function sendErrorToServer(
  ...
  try {
    ...
    if (response.ok) {
      ...
      console.log('✅ [ERROR BOUNDARY] Erro enviado para o servidor:', data.errorId)
      return data.errorId
    }
  } catch (sendError) {
    console.error('❌ [ERROR BOUNDARY] Falha ao enviar erro:', sendError)
  }
  return null
}
...
> {
  ...
  componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
    ...
    console.error("🚨 [CHECKOUT ERROR BOUNDARY] Erro capturado:", {
        ...
        <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
          <div className="max-w-md w-full bg-white rounded-xl shadow-lg p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">
              Ocorreu um erro inesperado no checkout. Por favor, tente novamente
              ou selecione os ingressos novamente.
            </p>
